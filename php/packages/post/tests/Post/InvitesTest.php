...
final class InvitesTest extends PostTestCase
{
    ...
    public function testList(): void
    {
        ...
        $invites = $this->client($http)->newsletter(self::NEWSLETTER_ID)->invites->list();
    ...
    public function testCreate(): void
    {
        ...
        $invite = $this->client($http)->newsletter(self::NEWSLETTER_ID)->invites->create(
    ...
    public function testDelete(): void
    {
        ...
        $this->client($http)->newsletter(self::NEWSLETTER_ID)->invites->delete(1);
