...
final class NewsletterTest extends PostTestCase
{
    ...
    public function testGetReturnsNewsletter(): void
    {
        ...
        $newsletter = $this->client($http)->newsletter(self::NEWSLETTER_ID)->get();
    ...
    public function testGetWithResourceApiKeyOverridesAuth(): void
    {
        ...
        $newsletter = $client->newsletter(self::NEWSLETTER_ID, 'resource-api-key')->get();
    ...
    public function testGetWithCustomHeadersOverridesNewsletterId(): void
    {
        ...
        $client->newsletter(self::NEWSLETTER_ID, headers: ['X-Newsletter-Id' => 'override'])->get();
    ...
    public function testDelete(): void
    {
        ...
        $this->client($http)->newsletter(self::NEWSLETTER_ID)->delete();
