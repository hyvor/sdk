...
final class SubscribersTest extends PostTestCase
{
    ...
    public function testCreateOrUpdate(): void
    {
        ...
        $subscriber = $this->client($http)->newsletter(self::NEWSLETTER_ID)->subscribers->createOrUpdate(
            [
    ...
    public function testBulkUpdate(): void
    {
        ...
        $response = $this->client($http)->newsletter(self::NEWSLETTER_ID)->subscribers->bulkUpdate(
            [
                'subscribers_ids' => [1, 2],
