...
final class WebsiteTest extends TalkTestCase
{
    public function testCreateSendsNameAndDomain(): void
    {
        ...
        $website = $this->client($http)->talk->websites->create([
            'name' => 'My Blog',
    ...
    public function testCreateValidationErrorThrows(): void
    {
        ...
        try {
            $client->talk->websites->create(['name' => 'X', 'domain' => 'taken.com']);
    ...
    public function testDelete(): void
    {
        ...
        $this->client($http)->talk->website(self::WEBSITE_ID)->delete();
    ...
    public function testDeleteWithResourceApiKeyOverridesAuth(): void
    {
        ...
        $this->client($http)->talk->website(self::WEBSITE_ID, 'resource-api-key')->delete();
